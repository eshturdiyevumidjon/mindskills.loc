...
?>
<?php Pjax::begin(['enablePushState' => false, 'id' => 'inbox-4-pjax']) ?>
<div class="container">
    <div id="mail-app" class="section">
        <div class="row">
            ...
            <div class="col s12">
                <div style="max-height: 440px;overflow-y: hidden;" class="col s3 m3 l3 card-panel">
                    <div id="email-sidebar">
                        <ul>
                            ...
                            <li>
                                <a href="/inbox/create?type=4" role="modal-remote">
                                  <div class="row">
                                ...
                                <a href="/inbox/index">
                                  <div class="row">
                                    <div class="col s4 right-align">
                                      ...
                                      <?php if($inbox > 0):?><small class="notification-badge"><?= $inbox ?></small><?php endif;?>
                                    </div>
                                    <div class="col s8 left-align">
                                      Входящие
                                    </div>
                            ...
                            <li style="background-color:rgba(0,0,0,0.09);border-radius: 10px;">
                                <a href="/inbox/deleting">
                                  <div class="row">
                                    <div class="col s4 right-align"> 
                                      <span class="material-icons"style="font-size: large;">delete
                                      </span>
                                    </div>
                                    <div class="col s8 left-align">
                                      Удаленные
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                          ...
                          <div class="col s4 left-align">
                                ...
                                <a class="mail-text" title="Просмотр" role="modal-remote" href="<?=Url::toRoute(['/inbox/view1',"id" => $model->id,"type"=>4])?>"><?=$model->title;?>
                                </a>
                          </div>
                          <div class="col s2">
                                <?php 
                          ...
                          <div class="col s2 right-align">
                                <span><?= date( 'H:i:m', strtotime($model->date_cr) ) ?></span>
                                <br>
                                <span><?= date( 'd.m.Y', strtotime($model->date_cr) ) ?></span>
                          </div>
                          <div class="col s2 left-align">
                              <?= Html::a('<i class="glyphicon glyphicon-trash"></i>',
                              ["/inbox/check-delete", 'id' => $model->id,"type" => 4] ,
                              [
