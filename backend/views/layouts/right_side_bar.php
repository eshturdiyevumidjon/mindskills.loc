    ...
    <li class="li-hover">
      <div class="row">
        ...
        <div id="settings" class="col s12">
          <h6 class="mt-5 mb-3 ml-3">ОБЩИЕ НАСТРОЙКИ</h6>
          <ul class="collection border-none">
            <li class="collection-item border-none">
              <div class="m-0">
                <span class="font-weight-600">Темный</span>
                <div class="switch right">
                  <label>
                    <input type="checkbox" name="dark_theme" value="1">
            ...
            <li class="collection-item border-none">
              <div class="m-0">
                <span class="font-weight-600">Полутемное</span>
                <div class="switch right">
                  <label>
                    <input type="checkbox" name="semi_dark" value="1">
                    <span class="lever"></span>
                  </label>
                </div>
              </div>
            ...
            <li class="collection-item border-none">
              <div class="m-0">
                <span class="font-weight-600">Световая</span>
                <div class="switch right">
                  <label>
            ...
            <li class="collection-item border-none">
              <div class="m-0">
                <span class="font-weight-600">Фиксированный Footer</span>
                <div class="switch right">
                  <label>
                    <input type="checkbox" name="fix_foot" value="1">
                    <span class="lever"></span>
                  </label>
                </div>
              </div>
            ...
            <li class="collection-item border-none">
              <div class="m-0">
                <span class="font-weight-600">Меню свернулось</span>
                <div class="switch right">
                  <label>
                    <input type="checkbox" name="coolap" value="1">
                    <span class="lever"></span>
                  </label>
                </div>
              </div>
