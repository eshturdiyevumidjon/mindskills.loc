...
<div class="users-form" style="padding: 20px;">
	...
	<div class="row">
		<div class="col-md-4">
	        <label>
	            <input type="checkbox" name="User[status]" id="7" value="1" <?= ($session['User[status]'] === null || 
	            $session['User[status]'] == 1) ? 'checked = ""': '' ?> > 
	    ...
	    <?php }?>
	    <label>
	            <input type="checkbox" name="User[balanc]" id="9" value="1" <?= ($session['User[balanc]'] === null || 
	            $session['User[balanc]'] == 1) ? 'checked = ""': '' ?> > 
