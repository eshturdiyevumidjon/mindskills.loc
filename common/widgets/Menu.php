...
class Menu extends \yii\widgets\Menu
{
     ...
     */
    public $labelTemplate = '<span class="nav-text">{label}</span>';
    public $submenuTemplate = "\n<div class='collapsible-body'>\n<ul>{items}\n</ul>\n</div>";
    public $activateParents = true;
    public $defaultIconHtml ='<i class="material-icons">donut_large</i>';
    public $options = ['class' => 'collapsible', 'data-collapsible' => 'accordion'];
    ...
    protected function renderItem($item)
    {
        if (isset($item['items'])) {
            ...
            $linkTemplate = '<a class="collapsible-header waves-effect waves-cyan">{icon}{label}</a>';
        } else {
        ...
        foreach ($items as $i => $item) {
            ...
            if (!empty($item['items'])) {
                $menu .= strtr($this->submenuTemplate, [
                    // '{show}' => $item['active'] ? "<span style='display: block'></span>" : '',
